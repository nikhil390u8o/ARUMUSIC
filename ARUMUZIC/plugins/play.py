...
async def play_next(chat_id: int):
    ...
    try:
        ...
        text = (
            f"<blockquote><b>❍ ɴᴇxᴛ sᴛʀᴇᴀᴍ sᴛᴀʀᴛᴇᴅ |</b>\n\n"
...
async def update_timer(chat_id, message_id, duration):
    ...
    while True:
        ...
        # FIX: Agar song end ke kareeb hai toh full bar edit karo aur loop break karo
...
async def play_cmd(client, msg: Message):
    ...
    # API SEARCH (Using Nubcoder for Rectangle Thumbnails)
    try:
        ...
        thumb_url = data.get("thumbnail") # YouTube Thumbnail (Rectangle)
    ...
    try:
        # Playing with Video support for rectangle display
        ...
        cap = (
            ...
            f"<b>‣ Rᴇǫᴜᴇsᴛᴇᴅ ʙʏ :</b> `{user_name}`\n"
            f"<b>‣ ʙᴏᴛ ʙᴀsᴇᴅ ᴏɴ : ᴀʀᴜ x ɴᴜʙᴄᴏᴅᴇʀ</b>"
        )
